;Práctica 3. PARTE II
;Se lee un switch o push-button externo conectado a p1.6 del puerto 1,
; se configura internamente la resistencia de pull-up.
...
;******************************************************************************
			bis.b	#00111111b,&P1DIR		;P1.0,P1.1,P1.2,P1.3,P1.4,P1.5 como
											;salidas, P1.6 como entrada.
			bis.b	#01000000b,&P1REN		;Configuración de resitencia pull-up
											;interna de P1.6.
;******************************************************************************
;				PROGRAMA PRINCIPAL
;******************************************************************************
			clr		P1OUT					;Limpia puerto 1.
MainLoop	mov		#0x4C,&P1OUT
			bit		#01000000b,&P1IN 		;Lee switch en P1.3
			jz		Active
			jmp		MainLoop
Active		mov		#0x54,&P1OUT			;Estado 1.
			call	#Ret2s					;Llama a subrutina de retardo de 2s.
			mov		#0x61,&P1OUT			;Estado 2.
